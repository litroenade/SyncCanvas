...
def test_user_modifies_layout():
    ...
    print("\n重新布局 (不同起始点):")
    result2 = calculate_layout(structure, "light", start_x=500, start_y=200)
...
def test_theme_switching():
    ...
    # 验证颜色不同
    assert light_colors['background'] != dark_colors['background'] or \
           light_colors['stroke'] != dark_colors['stroke'], \
           "不同主题应该有不同的颜色"
